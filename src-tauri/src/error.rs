...
impl AppErrorCode {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::MissingWorkspaceOrRecipe => "missing_workspace_or_recipe",
...
fn normalize_error_text(text: &str) -> &'static str {
    match text {
        ...
        "missing_workspace_or_recipe" => AppErrorCode::MissingWorkspaceOrRecipe.as_str(),
